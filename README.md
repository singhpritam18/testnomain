...
## Environments
- Preview: https://main--testnomain--singhpritam18.aem.page/
- Live: https://main--testnomain--singhpritam18.aem.live/
...
1. Open the `testnomain` directory in your favorite IDE and start coding :)
